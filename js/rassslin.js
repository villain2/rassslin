...
rrApp.config(['$routeProvider', function ($routeProvider)
{
	...
	when('/terms_of_use',
	{
		...
		templateUrl: 'http://localhost/wordpress/wp-content/themes/rassslin/' + Main.PartialsPath + '/terms_of_use.html'
	})
	.when('/privacy_policy',
	{
		controller: 'privacyCtrl',
		templateUrl: 'http://localhost/wordpress/wp-content/themes/rassslin/' + Main.PartialsPath + '/privacy_policy.html'
	})
	.otherwise(
	{
		controller: 'mainCtrl',
		templateUrl: 'http://localhost/wordpress/wp-content/themes/rassslin/partials/index.html'
	})
}]);
